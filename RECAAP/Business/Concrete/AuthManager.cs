...
namespace Business.Concrete
{
    public class AuthManager : IAuthService
    {
        ...
        public IDataResult<User> Register(UserForRegisterDto userForRegisterDto, string password)
        {
            ...
            return new SuccesDataResult<User>(user, Massages.UserRegistered);
        }
        ...
        public IDataResult<User> Login(UserForLoginDto userForLoginDto)
        {
            ...
            return new SuccesDataResult<User>(userToCheck.Data, Massages.SuccessfulLogin);
        }
        ...
        public IDataResult<AccesToken> CreateAccessToken(User user)
        {
            ...
            return new SuccesDataResult<AccesToken>(accessToken, Massages.AccessTokenCreated);
        }
    }
}
