...
namespace Business.Concrete
{
    public class PaymentManager : IPaymentService
    {
        ...
        public IResult CheckIfThisCardIsAlreadySavedForThisCustomer(Payment payment)
        {
            ...
            if (result != null) return new ErrorResult(Massages.ThisCardIsAlreadyRegisteredForThisCustomer);
        ...
        public IResult Pay(Payment payment)
        {
            ...
            if (result != null)
            {
                return new SuccessResult(Massages.PaymentSuccessful);
            }

            return new ErrorResult(Massages.PaymentDenied);
        }
